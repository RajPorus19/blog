...
- <img src="/images/browserless-logo.png" alt="Browserless" style="height:30px; vertical-align:middle; border-radius:4px;"> **[Browserless](https://github.com/microlinkhq/browserless)** (1 800⭐) : headless Chrome as a service. Utile si tu veux déléguer la partie navigateur à un service externe plutôt que de gérer des instances Chrome toi-même.
